...
from models import Model1, Model2, Model3, Model4, Model5, Model6, Arthur
...
total_models = [None, Model1, Model2, Model3, Model4, Model5, Model6, Arthur]
str_total_models = [None, 'Model1', 'Model2', 'Model3', 'Model4', 'Model5', 'Model6', 'Arthur']
...
for i, model in enumerate(str_models):
    ...
    columns.append([model+'_optimal', model+'_error'])
